...
export default function UpdateProduct() {
  ...
  useEffect(() => {
    if (productID) {
      axios.get(import.meta.env.VITE_SERVER_URL + '/api/product/' + productID)
        .then((response) => {
  ...
  const handleFormChange = (event) => {
    ...
    if (event.target.type === 'radio' && value === 'true') {
      setProduct((prevProduct) => ({ ...prevProduct, [name]: true }));
    } else if (event.target.type === 'radio' && value === 'false') {
      setProduct((prevProduct) => ({ ...prevProduct, [name]: false }));
    }
  }

  const handleFormSubmit = (event) => {
    event.preventDefault();
    axios.put(import.meta.env.VITE_SERVER_URL + '/api/product/' + productID, product)
      .then((response) => {
